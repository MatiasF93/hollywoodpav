Public Class Registrar_alquiler
    Enum estado
        primero
        modificar
    End Enum
    ...
    Private Sub Alquiler_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lbl_saldo_actual.Text = Inicio.principal.socio_actual._saldo
    End Sub
    ...
    Private Sub registrar_nuevo_alquiler()
        Dim datos As String = ""
        datos &= "num_factura=" & Me.numero_factura
    ...
    Private Sub modificar_detalle_alquiler()
        ...
        If Me.estado_alquiler = Registrar_alquiler.estado.modificar And Me.lbl_monto_total.Text = "0" Then
    ...
    Private Function comprobaciones() As Boolean
        ...
        If Me.lbl_monto_total.Text = "0" And estado_alquiler = Registrar_alquiler.estado.primero Then
